...
7개의 **Craft Pipeline** 에이전트와 18개의 **Dev Lifecycle** 에이전트가 역할을 분담합니다.

| Category | Agents | Purpose |
|:---------|:------:|:--------|
| **Craft Pipeline** | 7 | 코드 분석, 디자인 생성, 사이트 빌드, 검증 |
| **Dev Lifecycle** | 18 | 진행률 추적, 문서 관리, Git 워크플로우, 코드 리뷰, 테스트 |

> Agent 라우팅: `.claude/agents/MANIFEST.md` — 25 agents의 키워드(KO/EN) 매칭으로 자동 선택
